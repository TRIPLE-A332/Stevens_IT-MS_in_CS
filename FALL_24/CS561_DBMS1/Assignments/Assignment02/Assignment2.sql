with q1 as --verage of the current months
(
	select cust, prod, month, avg(quant) during_avg
	from sales
	group by cust, prod, month
),
q2 as --average of the previous months
(
...
q3 as --average of the next months
(
...
q4 as --query with the average of the previous months
(
...
q5 as -- average of the previous and next months
(
