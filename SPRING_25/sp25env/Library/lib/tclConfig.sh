...
# installed.
TCL_PREFIX='D:/Stevens GIT/Stevens_IT-MS_in_CS/SPRING_25/sp25env\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Stevens GIT/Stevens_IT-MS_in_CS/SPRING_25/sp25env\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Stevens GIT/Stevens_IT-MS_in_CS/SPRING_25/sp25env\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Stevens GIT/Stevens_IT-MS_in_CS/SPRING_25/sp25env\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Stevens GIT/Stevens_IT-MS_in_CS/SPRING_25/sp25env\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Stevens GIT/Stevens_IT-MS_in_CS/SPRING_25/sp25env\Library\lib\tclstub86.lib'
